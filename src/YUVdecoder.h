...
public:
    ...
    static QList<cv::Mat*> bayerBG_RAW16(QString yuvfilename,int W, int H, int startframe, int totalframe);
    static QList<cv::Mat*> bayerGB_RAW16(QString yuvfilename,int W, int H, int startframe, int totalframe);
    static QList<cv::Mat*> bayerRG_RAW16(QString yuvfilename,int W, int H, int startframe, int totalframe);
    static QList<cv::Mat*> bayerGR_RAW16(QString yuvfilename,int W, int H, int startframe, int totalframe);
