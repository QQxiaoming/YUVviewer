...
class Ui_MainWindow(object):
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.groupBox.setTitle(_translate("MainWindow", "Frame Size"))
        self.frameSizeType_CIF_RadioButton.setText(_translate("MainWindow", "CIF"))
        self.frameSizeType_Other_RadioButton.setText(_translate("MainWindow", "Other"))
        self.frameSizeType_QCIF_RadioButton.setText(_translate("MainWindow", "QCIF"))
        self.label.setText(_translate("MainWindow", "YUV Format"))
        self.YUVFormat_ComboBox.setItemText(0, _translate("MainWindow", "YV12"))
        self.YUVFormat_ComboBox.setItemText(1, _translate("MainWindow", "I420"))
        self.YUVFormat_ComboBox.setItemText(2, _translate("MainWindow", "YUY2"))
        self.YUVFormat_ComboBox.setItemText(3, _translate("MainWindow", "UYUV"))
        self.YUVFormat_ComboBox.setItemText(4, _translate("MainWindow", "4:2:2"))
        self.YUVFormat_ComboBox.setItemText(5, _translate("MainWindow", "4:4:4"))
        self.label_2.setText(_translate("MainWindow", "Witdth"))
        self.label_3.setText(_translate("MainWindow", "Height"))
        self.groupBox_2.setTitle(_translate("MainWindow", "Play Parameters"))
        self.label_4.setText(_translate("MainWindow", "Frame Rate"))
        self.frameRate_ComboBox.setItemText(0, _translate("MainWindow", "30"))
        self.frameRate_ComboBox.setItemText(1, _translate("MainWindow", "60"))
        self.frameRate_ComboBox.setItemText(2, _translate("MainWindow", "120"))
        ...
        self.openFolder_PushButton.setText(_translate("MainWindow", "Open folder"))
        self.about_PushButton.setText(_translate("MainWindow", "About"))
        self.help_PushButton.setText(_translate("MainWindow", "Help"))
